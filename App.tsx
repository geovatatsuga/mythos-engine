...
const ChaptersView = lazy(() => import('./components/ChaptersView'));
...
const loadingFallback = (
  <div className="flex min-h-[40vh] items-center justify-center">
    <div className="rounded-full border border-stone-300 bg-white px-4 py-2 text-sm text-stone-500 shadow-sm">
      ...
      {!hasStarted ? (
        ...
        <div className="flex h-screen bg-background text-text font-sans">
          <Sidebar
            ...
            setCurrentView={setCurrentView}
            universeExists={!!universe}
            locked={!!autoGenProgress && autoGenProgress.phase !== 'done' && autoGenProgress.phase !== 'aborted'}
          />
          <ErrorBoundary
